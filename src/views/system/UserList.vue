            ...
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="手机号码" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-input placeholder="输入手机号码查询" v-model="queryParam.loginName"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="联系电话" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-input placeholder="输入联系电话查询" v-model="queryParam.loginName"></a-input>
                </a-form-item>
              </a-col>
              <!-- <a-col :md="6" :sm="24">
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { title: '联系人', dataIndex: 'loginName', width: 100, align: "left"},
          { title: '手机号码', dataIndex: 'loginName', width: 100, align: "left"},
          { title: '联系电话', dataIndex: 'loginName', width: 100, align: "left"},
          { title: '电子邮箱', dataIndex: 'loginName', width: 100, align: "left"},
