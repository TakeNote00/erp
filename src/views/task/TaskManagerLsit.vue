    ...
    data () {
      return {
        ...
        defColumns: [
          ...
          { title: '生产单号', dataIndex: 'produceNo',width:140},
          ...
          { title: '订购数量', dataIndex: 'orderNumber',width:140},
          { title: '生产数量', dataIndex: 'produceNumber',width:140},
          { title: '计划完工日期', dataIndex: 'planFinishTimeStr',width:140},
          { title: '单据日期', dataIndex: 'createTimeStr',width:140},
